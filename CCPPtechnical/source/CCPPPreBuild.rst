...
In addition to the autogenerated caps, the *capgen* script also creates a ``datatable.xml``. This file contains all the information needed by the build system, and can be queried as follows:
