...
*Listing 6.5: Autogenerated files from capgen.*
...
*Listing 6.7: In this example, the variable* ``PBLH`` *was added to the suite data module. All variables in the suite data module are allocated (deallocated) during the suite initialization (finalization) step.*
