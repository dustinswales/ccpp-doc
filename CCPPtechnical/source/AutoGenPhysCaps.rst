...
For organizational reasons, and to keep the autogenerated *suite caps* lean, the framework will generate the following infrastructure referenced by the caps. 
...
These modules are imported directly into the *suite cap*.
...
*Listing 5.4: CCPP Suite Data module associated with example in* :numref:`Section %s <SuiteVariables>` 
...
*Listing 5.5: CCPP Suite Types module associated with example in* :numref:`Section %s <OptionalVariables>` 
