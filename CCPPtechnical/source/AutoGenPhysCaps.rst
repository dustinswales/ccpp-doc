...
For Scheme's with optional arguments, the CCPP framework will generate local pointers in the Group cap. These local pointers are associated within the Group cap, just prior to calling the Scheme.
